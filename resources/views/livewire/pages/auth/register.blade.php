...
new #[Layout( 'layouts.guest' )] class extends Component {
	...
	public function register(): void {
		$validated = $this->validate( array(
			...
			'password' => array( 'required', 'string', 'confirmed', Rules\Password::defaults() ),
		) );
...
<div>
				<form wire:submit="register">
								...
								<div>
												...
												<x-input-text wire:model="name" id="name" class="block mt-1 w-full" type="text" name="name" required
								...
								<div class="mt-4">
												...
												<x-input-text wire:model="email" id="email" class="block mt-1 w-full" type="email" name="email"
