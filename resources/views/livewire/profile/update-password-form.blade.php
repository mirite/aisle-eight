	...
	public function updatePassword(): void {
		try {
			$validated = $this->validate( array(
				'current_password' => array( 'required', 'string', 'current_password' ),
				'password' => array( 'required', 'string', Password::defaults(), 'confirmed' ),
			) );
...
<section>
				...
				<form wire:submit="updatePassword" class="mt-6 space-y-6">
								<div>
												...
												<x-input-text wire:model="current_password" id="update_password_current_password" name="current_password"
